...
export default function PostPage() {
  ...
  return (
    <main className="p-3 flex flex-col max-w-[90%] mx-auto min-h-screen">
      <h1 className="text-3xl mt-10 p-3 text-center font-serif w-full mx-auto lg:text-4xl">
        {post && post.title}
      </h1>
      <Link
      ...
      <div className="flex justify-between p-3 border-b border-slate-500 mx-auto w-full text-xs">
        ...
        <span className="italic">
          {post && (post.content.length / 6000).toFixed(0)} mins read
        </span>
      </div>
      <div
